...
public class JDBC_CRUDTest {
   private static final String ADRESS = "jdbc:mysql://localhost:3306/webpr_6lab";
   private static final String LOGIN="vasyakaban";
   private static final String PASSWORD="384557";
